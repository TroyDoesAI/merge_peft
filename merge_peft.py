...
python .\merge_peft.py --base_model_name_or_path  .\Mermaid\ --peft_model_path .\Mermaid_Lora --output_dir Mermaid12B --device cuda
# python .\merge_peft.py --base_model_name_or_path  .\Mermaid\ --peft_model_path .\Mermaid_Lora --output_dir MermaidMixtral-2x7b --device cuda
"""
import torch
import os
import logging
